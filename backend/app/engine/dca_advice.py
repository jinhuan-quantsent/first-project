...
SIGNAL_TO_DESCRIPTION: dict[str, str] = {
    "S+": "极度恐惧区域，历史数据显示定投长期收益最高；建议3倍定投，积极收集低价筹码",
    "S":  "恐惧情绪浓厚，市场大幅回调，定投性价比极高；建议2倍定投加速建仓",
    "A":  "偏恐惧区域，估值进入合理偏低区间；建议1.5倍定投适度加仓",
    "B":  "情绪中性，市场多空均衡；建议标准定投，保持纪律执行",
    "C":  "偏贪婪区域，估值逐步走高；建议0.5倍定投，减半降低买入成本",
    "D":  "贪婪情绪明显，追涨风险加大；建议暂停定投，等待回调",
